...
import se.kth.helloworld.Racer;
		   ...
		   try
			{
			   ...
			   location = "./src/main/java/se/kth/helloworld/Racer.java";
			   File file = new File(location);
				...
				if(!isFileExist)
				{
					...
					location = "racer/src/main/java/se/kth/helloworld/Racer.java";
...
public void displayErrorTrace() {	
		...
		se.kth.jpf_visual.ErrorTracePanel gui = new se.kth.jpf_visual.ErrorTracePanel();
			...
			/*Racer.startVisTime = System.nanoTime();
		    long totaltime =Racer.startVisTime-Racer.startMainTime;
		    System.out.println("before:"+TimeUnit.NANOSECONDS.toMillis(totaltime)+"\n");*/
		
				gui.drowJVMErrTrace(p, true);
			/* Racer.endTraceTime = System.nanoTime();
			    long totaltimeafter =Racer.endTraceTime-Racer.startMainTime;
