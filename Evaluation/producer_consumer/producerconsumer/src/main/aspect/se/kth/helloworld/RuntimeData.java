...
public class RuntimeData {
	...
	String app="VA4JVM for ProducerConsumer program";
		   ...
		   try
			{
			   ...
			   location = "./src/main/java/se/kth/helloworld/ProducerConsumer.java";
			   File file = new File(location);
				...
				if(!isFileExist)
				{
					...
					location = "producerconsumer/src/main/java/se/kth/helloworld/ProducerConsumer.java";
...
public void displayErrorTrace() {	
		...
		se.kth.jpf_visual.ErrorTracePanel gui = new se.kth.jpf_visual.ErrorTracePanel();
			...
			/*ProducerConsumer.startVisTime = System.nanoTime();
		    long totaltime =ProducerConsumer.startVisTime-ProducerConsumer.startMainTime;
		    System.out.println("before visualization time:"+TimeUnit.NANOSECONDS.toMillis(totaltime)+"\n");*/
		
				gui.drowJVMErrTrace(p, true);	
				/*ProducerConsumer.endTraceTime = System.nanoTime();
			    long totaltimeafter =ProducerConsumer.endTraceTime-ProducerConsumer.startMainTime;
