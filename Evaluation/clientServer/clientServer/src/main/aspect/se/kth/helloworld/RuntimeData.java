...
public class RuntimeData {
	...
	String app="VA4JVM for ServerSocket program";
		   ...
		   try
			{
			   ...
			   location = "./src/main/java/se/kth/helloworld/ServerSockt.java";
			   File file = new File(location);
				...
				if(!isFileExist)
				{
					...
					location = "clientServer/src/main/java/se/kth/helloworld/ServerSockt.java";
