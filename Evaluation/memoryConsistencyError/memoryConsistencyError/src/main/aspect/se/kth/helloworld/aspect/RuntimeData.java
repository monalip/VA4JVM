		   ...
		   try
			{
			   ...
			   location = "./src/main/java/se/kth/helloworld/MemoryConsistencyErrorExample.java";
			   File file = new File(location);
				...
				if(!isFileExist)
				{
					...
					location = "memoryConsistencyError/src/main/java/se/kth/helloworld/MemoryConsistencyErrorExample.java";
